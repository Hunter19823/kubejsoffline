...
public class ReflectionHelperNeoForge implements ReflectionHelper {
    static {
...
//				}
    ...
    public Class[] getEventClasses() {
        return new Class[]{KubeEvent.class, Event.class, dev.architectury.event.Event.class, RecipeSerializer.class};
    }
}

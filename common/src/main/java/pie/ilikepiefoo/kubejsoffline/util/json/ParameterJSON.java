...
public class ParameterJSON {
    ...
    public static JsonArray of( @Nonnull Executable executable ) {
        ...
        for (var parameter : params.get()) {
            ...
            if (parameterJson == null || parameterJson.size() == 0) return null;
    ...
    public static JsonObject of( @Nonnull Parameter parameter ) {
        ...
        if (temp == null || temp.isBlank()) return null;
        ...
        object.addProperty(
            JSONProperty.PARAMETER_TYPE.jsName,
            type.get(JSONProperty.TYPE_ID.jsName).getAsInt()
        );
